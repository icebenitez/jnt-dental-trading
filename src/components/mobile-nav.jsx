      ...
      <SheetContent side="left" className="pr-0">
        ...
        <ScrollArea className="my-4 h-[calc(100vh-8rem)] pb-10 pl-6">
          <div className="flex flex-col space-y-3">
            <MobileLink href="/category/equipment" onOpenChange={setOpen}>
              Equipment
            </MobileLink>
            <MobileLink href="/category/instruments" onOpenChange={setOpen}>
              Instruments
            </MobileLink>
            <MobileLink href="/category/consumables" onOpenChange={setOpen}>
              Consumables
            </MobileLink>
          </div>
        </ScrollArea>
